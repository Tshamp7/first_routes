...
# Comment.create!(artwork_id: 1, user_id: 2, body: "Hey that looks great! What a cool engine! Whats it made out of?!")
# Comment.create!(artwork_id: 2, user_id: 4, body: "OMG I LOVE CAT ART")
# Comment.create!(artwork_id: 3, user_id: 6, body: "That dead squirrel look so delicious kai!")
# Comment.create!(artwork_id: 3, user_id: 1, body: "What a good girl you are kai! Nice catch!")
# Comment.create!(artwork_id: 4, user_id: 3, body: "I keep whacking my dog head on this big thing!")
# Comment.create!(artwork_id: 5, user_id: 1, body: "Hey Grandma, those look like my cookies!?!")
